...
$query = mysqli_query($connect, "SELECT id, tittle, content, author, picture, cast(d_entry as date) as d_entry, cast(d_update as date) as d_update, deleted FROM t_article WHERE tittle like '%$keyword%' AND b_deleted = 0 ORDER BY 1");
